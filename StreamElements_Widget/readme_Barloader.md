...
To use a simple bar load app in an overlay which can be modified and activated in chat, use the following code in the appropriate place for the overlay item.
...
```html
  <section>
            ...
            <div class="bar-img">
                <img class="barbell" id="barbell" src="https://raw.githubusercontent.com/UBERCRUZER/bar-loader/master/static/img/45.png" />
            </div>
 </section>
```
...
```js
const imgUrl="https://raw.githubusercontent.com/UBERCRUZER/bar-loader/master/";
let cooldown = 0;
...
function changeImage(weight,label,collars)
{
    ...
    if(!isNaN(weight)) {
        ...
        if (label === "lbs") {
            ...
            document.getElementById("barbell").src = imgUrl+"static/img/" + round5(weight) + ".png";
            ...
            if (!collars) {
                ...
                document.getElementById("barbell").src = imgUrl+"static/img/kgNoCollar/" + round25(weight) + ".png";
                ...
                document.getElementById("barbell").src = imgUrl+"static/img/kg/" + round25(weight) + ".png";
                updateWeightsKG(weight)
            }
        }
    }
